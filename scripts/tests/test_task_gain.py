...
def test_input_image_type(tmp_path):
    """
    Test if user provide correct input file format: dm4
    """
    task_folder = os.path.join(tmp_path, 'task_gain_01')
...
def test_exception_wrong_type(tmp_path):
    """
...
def test_output_image_type(tmp_path):
    """
